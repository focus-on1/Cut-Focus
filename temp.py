...
def process_image(image_path, text, output_image="final_output.jpg"):
    ...
    draw = ImageDraw.Draw(image_with_banner_pil)  # Définir draw ici
    
    font_path = "Rubik-Bold.ttf"  # Assurez-vous que ce fichier existe dans votre répertoire
...
def main():
    api_key = "7532420010:AAHvBT9yK_mc0JaeEdqU40ULbp2W6T-1jfw"  # Remplacez par votre API key
